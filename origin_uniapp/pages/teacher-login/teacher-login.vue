<template>
    <view class="page-wrapper">
        ...
        <!-- #ifdef MP-WEIXIN -->
        <mp-weixin-page-header title="教师登录" color="white" background="#10B981" />
        <!-- #endif -->
        <!-- #ifndef MP-WEIXIN -->
        <app-navigation-bar title="教师登录" :back="true" color="white" background="#10B981"></app-navigation-bar>
        <!-- #endif -->
